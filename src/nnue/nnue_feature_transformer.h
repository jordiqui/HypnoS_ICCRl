...
template<Hypnos::Eval::NNUE::IndexType TransformedFeatureDimensions>
struct std::hash<Hypnos::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>> {
    std::size_t
    operator()(const Hypnos::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>& ft)
      const noexcept {
